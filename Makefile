...
sim:
	echo "no" | sdk/cmdline-tools/bin/avdmanager --verbose create avd --force --name "android-31" --package "system-images;android-31;google_apis_playstore;x86_64" --tag "google_apis" --abi "x86_64"
